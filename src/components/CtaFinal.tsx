...
export default function CtaFinal() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message = `Olá José! 👋%0A%0AVim pelo site: *alexandraconsultoraremax.vercel.app*%0A%0A*Dados do Cliente:*%0A👤 Nome: ${name}%0A📧 Email: ${email}%0A📞 Telefone: ${phone}%0A%0A*Interesse:*%0A📌 ${interestText}`;
